try {
  window.__bitium = new function() {
    console.log("start loading javascript files");
    (function(a, b) {
      function cy(a) {
      ...
      function bk(a, b) {
        ...
        a.value && (b.value = a.value)), b.removeAttribute(f.expando), b.removeAttribute("_submit_attached"), b.removeAttribute("_change_attached"));
      }
      function bj(a, b) {
      ...
      f.event = {add:function(a, c, d, e, g) {
        ...
        a.pageX == null && (d.clientX != null && (e = a.target.ownerDocument || c, f = e.documentElement, g = e.body, a.pageX = d.clientX + (f && f.scrollLeft || (g && g.scrollLeft || 0)) - (f && f.clientLeft || (g && g.clientLeft || 0)), a.pageY = d.clientY + (f && f.scrollTop || (g && g.scrollTop || 0)) - (f && f.clientTop || (g && g.clientTop || 0)))), !a.relatedTarget && (i && (a.relatedTarget = i === a.target ? d.toElement : i)), !a.which && (h !== b && (a.which = h & 1 ? 1 : h & 2 ? 3 : h & 
        4 ? 2 : 0));
        return a;
      }}, fix:function(a) {
        if (a[f.expando]) {
    ...
    console.log("finish loading javascript files");
    $ = jQuery.noConflict();
    var page = new window.__bitium_Page;
    this.run_step = function(step, last_step, callback) {
      page.last_input = last_step;
      page.run_step(step, callback);
    };
  };
